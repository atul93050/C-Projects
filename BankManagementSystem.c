...
int main()
{
    ...
    // Main menu function ko call kiya hai
...
start:
    ...
    case 6:
        ...
        // Invalid input case me dubara input mangta hai
...
void user_login()
{
    ...
    if ((strcmp(pwd, new.password)) == 0)
    { // Password match check karte hain
        printf("Welcome to our Bank Management System...\n  %s Ji\n", new.fname, new.lname);
        printf("Adhar No is : %s\n", new.Adhar);
...
void withdraw_money()
{
    ...
    if (transaction.balance >= transaction.withdraw)
    {                                                                     // Check karte hain balance sufficient hai ya nahi
...
start:
    ...
    else
    {
        ...
        if (transaction.balance >= transfer_amount)
        {                                                                // Check karte hain balance sufficient hai ya nahi
